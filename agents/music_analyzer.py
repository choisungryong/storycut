    ...
    def align_lyrics_to_audio(self, audio_path: str, lyrics_lines: list, audio_duration_sec: float = 0.0, _is_retry: bool = False) -> Optional[list]:
        ...
        try:
            ...
            prompt_text = (
                ...
                "## CONSECUTIVE LINES (VERY IMPORTANT)\n"
                "- Lines with consecutive indices (e.g., line 11 then line 12) are part of the SAME verse/section.\n"
                "- Consecutive lines are typically sung 0.5-3 seconds apart. A gap of more than 15 seconds between consecutive indices is almost ALWAYS an error.\n"
                "- If you think there is a 30+ second gap between line N and line N+1, you are probably WRONG. Listen again more carefully.\n"
                "- Large gaps (10+ seconds) should ONLY appear between non-consecutive indices, indicating a section break or instrumental interlude.\n\n"
                "## INSTRUMENTAL BREAKS\n"
                "- If there is a genuine instrumental break between song sections, there will be a gap in line indices (not consecutive).\n"
