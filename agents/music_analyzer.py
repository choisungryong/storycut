    ...
    def align_lyrics_to_audio(self, audio_path: str, lyrics_lines: list, audio_duration_sec: float = 0.0) -> Optional[list]:
        ...
        try:
            ...
            prompt_text = (
                ...
                "- Example: if vocals end at 60s and resume at 75s, NO lyric should have any timestamp between 60-75s.\n"
                "  WRONG: {..., \"end\": 59.0}, {\"start\": 61.0, ...}  <-- lyrics during instrumental!\n"
                "  RIGHT: {..., \"end\": 59.0}, {\"start\": 75.2, ...}  <-- gap matches instrumental break\n"
