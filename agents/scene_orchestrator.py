...
"""
    ...
    def build_prompt(
        ...
        _STYLE_PREFIX = {
            ...
            "illustration": "digital painting illustration, visible painterly brushstrokes with textured edges, concept art quality, rich layered color palette, soft blended lighting with painted shadows, art station trending quality, hand-painted atmosphere with depth and warmth, attractive characters with ideal proportions, NO moles, NO scars, NO blemishes",
        }
